...
int start()
{
   ...
   if (alertsOn)
   {
     ...
     if (KFull[whichBar]>overBought && KFull[whichBar+1]<overBought) doAlert(overBought+" line crossed up");
     if (KFull[whichBar]<overSold   && KFull[whichBar+1]>overSold)   doAlert(overSold+" line crossed down");
   }
