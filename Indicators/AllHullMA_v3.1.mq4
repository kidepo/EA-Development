...
//---- 
   ...
   limit = MathMax(limit,TimeFrame/Period()+1);   
      ...
      double hma = iCustom(NULL,TimeFrame,IndicatorName,0,Price,Length,DampingFactor,Shift,MA_Method,ColorMode,SoundMode,SoundShift,BuySound,SellSound,0,y);    
         
      hMA[shift] = hma;
         
         if(ColorMode > 0)
         {
         int hmatrend = iCustom(NULL,TimeFrame,IndicatorName,0,Price,Length,DampingFactor,Shift,MA_Method,ColorMode,SoundMode,SoundShift,BuySound,SellSound,5,y);      
