...
//|                                 Copyright © 2009.06.17, SwingMan |
//|                                                fxfariz@gmail,com |
//+------------------------------------------------------------------+
#property copyright "Copyright © 2009.06.17, SwingMan"
#property link      ""
...
int init()
  {
   ...
   IndicatorShortName("smFisherTransform3_impr " +" ("+period+")");
   ...
   for(int i=0; i<limit; i++)
    {
      ...
      else
      {
         ...
         else ExtBuffer0[i]=0.1*MathLog((1+Value)/(1-Value))+0.9*Fish1; //original Ehlers is 0.25/0.5...?
      }
